...
class Pheanstalk {
    ...
    $tube, $data, $priority = self::DEFAULT_PRIORITY, $delay = self::DEFAULT_DELAY, $ttr = self::DEFAULT_TTR
    ) {
        $this->useTube($tube);
    ...
    $job, $priority = self::DEFAULT_PRIORITY, $delay = self::DEFAULT_DELAY
    ) {
        $this->_dispatch(
    ...
    public function printTubeStats($tube) {
        
        $obj = $this->statsTube($tube);
        echo 'Name = ' . $obj['name'];
        echo '<br>';
        echo 'current-jobs-urgent = ' . $obj['current-jobs-urgent'];
        echo '<br>';
        echo 'current-jobs-ready = ' . $obj['current-jobs-ready'];
        echo '<br>';
        echo 'current-jobs-reserved = ' . $obj['current-jobs-reserved'];
        echo '<br>';
        echo 'current-jobs-delayed = ' . $obj['current-jobs-delayed'];
        echo '<br>';
        echo 'total-jobs = ' . $obj['total-jobs'];
        echo '<br>';
        echo 'current-using = ' . $obj['current-using'];
        echo '<br>';
        echo 'current-watching = ' . $obj['current-watching'];
        echo '<br>';
        echo 'current-waiting = ' . $obj['current-waiting'];
        echo '<br>';
        echo 'cmd-pause-tube = ' . $obj['cmd-pause-tube'];
        echo '<br>';
        echo 'pause = ' . $obj['pause'];
        echo '<br>';
        echo 'pause-time-left = ' . $obj['pause-time-left'];
        echo '<br>';
    }
